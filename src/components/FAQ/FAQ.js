        ...
        <Box w='100%'>
            <Box mx={{ base: 12, lg: 32 }} py={32} align='center'>
                ...
                <Accordion allowMultiple maxW={850}>
                    ...
                    <FAQItem q='What is Into The Unknown?' a='dunno' />
                    <FAQItem q='What is the Pre-Sale Mint cost?' a='TBD' />
                    <FAQItem q='What is the Public Mint cost?' a='TBD' />
                    <FAQItem q='When are the Mint Dates?' a='TBD' />
                </Accordion>
            </Box>
        </Box>
    )
